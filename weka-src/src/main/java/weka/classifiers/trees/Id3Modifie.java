...
public class Id3Modifie
  ...
  public String toString() {
    ...
    if ((m_Distribution == null) && (m_Successors == null)) {
      return "Id3Modifie: No model built yet.";
    }
    return "Id3Modifie\n\n" + toString(0);
  }
  ...
  private double computeEntropy(Instances data) throws Exception {
    ...
    for (int j = 0; j < data.numClasses(); j++) {
      if (classCounts[j] > 0) {
		...
		//Nouveau formule utiliser pour calculer l'entropy
		entropy += Math.pow(classCounts[j] / (double)data.numInstances(), getAlpha()) - 1;
      }
    }
